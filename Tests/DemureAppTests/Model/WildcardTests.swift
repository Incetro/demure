...
final class WildcardTests: XCTestCase {
    ...
    func match(_ pattern: String, _ testString: String) -> Bool {
        Wildcard(pattern: pattern).check(testString)
    }
    ...
    func testMatch() {
        ...
        XCTAssertTrue(match("http://?o[oz].b*z.com/{*.js,*.html}", "http://foo.baaz.com/jquery.min.js"))
        XCTAssertTrue(match("http://?o[oz].b*z.com/{*.js,*.html}", "http://moz.buzz.com/index.html"))
        XCTAssertFalse(match("http://?o[oz].b*z.com/{*.js,*.html}", "http://moz.buzz.com/index.htm"))
        XCTAssertFalse(match("http://?o[oz].b*z.com/{*.js,*.html}", "http://moz.bar.com/index.html"))
        XCTAssertFalse(match("http://?o[oz].b*z.com/{*.js,*.html}", "http://flozz.buzz.com/index.html"))
    }
    ...
    func testStars() {
        XCTAssertTrue(match("http://foo.com/**/{*.js,*.html}", "http://foo.com/bar/jquery.min.js"))
        XCTAssertTrue(match("http://foo.com/**/{*.js,*.html}", "http://foo.com/bar/baz/jquery.min.js"))
        XCTAssertTrue(match("http://foo.com/**", "http://foo.com/bar/baz/jquery.min.js"))
    }
